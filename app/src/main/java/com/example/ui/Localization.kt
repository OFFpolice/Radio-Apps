...
object Loc {
    private val en = mapOf(
        ...
        "theme_dark" to "Dark",
        "language_default_hint" to "English by default",
        "theme_default_hint" to "System default",
        "socials_heading" to "Author's Socials",
    ...
    private val ru = mapOf(
        ...
        "language_auto" to "Определить автоматически",
        ...
        "language_default_hint" to "английский по умолчанию",
        "theme_default_hint" to "система по умолчанию",
        "socials_heading" to "Соцсети автора",
    ...
    private val uk = mapOf(
        ...
        "language_auto" to "Визначити автоматично",
        ...
        "theme_dark" to "Темна",
        "language_default_hint" to "англійська за замовчуванням",
        "theme_default_hint" to "система за замовчуванням",
        "socials_heading" to "Соцмережі автора",
